...
| `E08` | `active` | `D5` | `E03`, `E05` | iOS/iPadOS native editor surface、touch selection、hardware keyboard、IME、viewport virtualization を同じ editor core 上へ実装する。Mac と同じ transaction fixture が通ること。 |
