...
| `E05` | `active` | `D4` | `E02` | Tree-sitter incremental parse と LSP coordinate/lifecycle を実装する。edit delta だけで parse を更新し、stale diagnostic/completion を revision で拒否すること。 |
