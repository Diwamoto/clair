...
| `V04` | `queued` | `D4` | `V01`, `H02` | Project model と workspace 永続化。Git の有無を問わない local folder を Project として開き、複数 Project を 1 process で切替。Project ごとに layout/tab/terminal/agent/notification/settings を保持・復元する。sample file tree を実 file system に置換。復元不能な layout を安全に縮退。 |
