...
| `E09` | `active` | `D5` | `E03`, `E05`, `N06` | revision-aware review anchor、line comment、thread、stale/orphaned/resolved、AI suggestion apply/reject/partial/undo を実装する。編集後の誤った再配置や二重適用がないこと。 |
