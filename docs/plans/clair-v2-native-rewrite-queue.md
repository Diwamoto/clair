...
| `E07` | `active` | `D5` | `E03`, `E06` | `NSTextInputClient`、日本語 IME、marked text、clipboard、drag/drop、accessibility、system cursor を実装する。実機 IME/VoiceOver と Unicode matrix が通ること。 |
