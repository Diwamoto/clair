...
scripts/v2-ghostty.sh            vendor | verify | status | clean
packages/ClairV2Core
  Sources/ClairV2GhosttyABI      C: pinned ABI subset + layout static asserts
  Sources/ClairV2Ghostty         Swift: @MainActor boundary, typed errors,
