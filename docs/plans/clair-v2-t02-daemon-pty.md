...
- `ClairV2PTYAgentProcessFactory` を登録済み provider に指定すると、Swift v2
...
- `ClairV2TerminalInputRequest` は raw bytes と、その SHA-256 digest を含む
  B03 operation metadata を結び付ける。認証済み `input(_:on:)` と trusted local
  `localInput` は同じ FIFO / dedupe window を使う。入力に resize owner は不要。
- `ClairV2TerminalFrame.encoded()` は B03 length prefix、big-endian epoch (8 bytes)、
...
```sh
swift test --package-path packages/ClairV2Core --scratch-path /private/tmp/clair-v2-t02-build --filter t02
swift test --package-path packages/ClairV2Core --scratch-path /private/tmp/clair-v2-t02-build --filter 't02|h10'
swift build --package-path packages/ClairV2Apps --scratch-path /private/tmp/clair-v2-t02-app-build --product ClairDaemon
clang -Wall -Wextra -Werror -fsyntax-only -I packages/ClairV2Core/Sources/ClairV2PTY/include packages/ClairV2Core/Sources/ClairV2PTY/ClairV2PTY.c
git diff --check
```
...
- `packages/ClairV2Core/Package.swift`
- `packages/ClairV2Apps/Package.swift`
- `packages/ClairV2Apps/Sources/ClairDaemon/main.swift`
- `packages/ClairV2Core/Sources/ClairV2Agent/ClairV2AgentRuntime.swift`
- `packages/ClairV2Core/Sources/ClairV2Agent/ClairV2PTYAgentProcess.swift`
- `packages/ClairV2Core/Sources/ClairV2DaemonKit/ClairDaemonHost.swift`
- `packages/ClairV2Core/Sources/ClairV2DaemonKit/ClairV2TerminalBoundary.swift`
- `packages/ClairV2Core/Sources/ClairV2PTY/ClairV2PTY.c`
- `packages/ClairV2Core/Sources/ClairV2PTY/include/ClairV2PTY.h`
- `packages/ClairV2Core/Sources/ClairV2Terminal/ClairV2TerminalStream.swift`
- `packages/ClairV2Core/Sources/ClairV2Transport/ClairV2DispatchCommit.swift`
- `packages/ClairV2Core/Tests/ClairV2CoreTests/ClairV2TerminalTests.swift`
- `packages/ClairV2Core/Tests/ClairV2CoreTests/ClairV2TerminalBoundaryTests.swift`
- `packages/ClairV2Core/Tests/ClairV2CoreTests/ClairV2TerminalHostTests.swift`
- この T02 専用メモ
