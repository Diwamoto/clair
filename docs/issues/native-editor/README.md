...
| [NE-05](NE-05.md) | メモリ保持を調べてタブ解放・大規模ファイル方針を作る | NE-00 | done |
...
4. NE-11は01〜05の必要ゲート通過後。現状はNE-01/03がblocked、NE-05がopenのため着手しない。NE-14は02後に実装できるが、本番接続の統合はNE-11と直列化する。NE-12は11/14後。NE-13で通常編集とdiffの結論を統合する。
