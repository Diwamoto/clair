...
[local development runbook](../../runbooks/local-development.md)へ追記し、実施結果をitemへ記録する。
...
- [local development runbook](../../runbooks/local-development.md)にIMEとVoiceOverの手動確認手順を追記する。
- [native editor issues](../../issues/native-editor/README.md)のNE-11とNE-15〜NE-23へsupersede注記を入れる。
