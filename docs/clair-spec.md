...
- GitHub Actions で Stable artifact に署名を付け、公開 GitHub Release へ発行する
  ([ADR-0009](decisions/0009-stable-github-update-distribution.md))。Apple
  Developer ID signing と notarization は一般配布が必要になるまで後続判断
