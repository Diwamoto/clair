...
public protocol ClairV2MobileTransport: Sendable {
...
extension ClairV2MobileTransport {
...
public actor ClairInProcessMobileTransport: ClairV2MobileTransport {
...
/// `ClairV2MobileTransport`; it must never silently substitute a raw socket or
...
public actor ClairV2MobileClient {
  private let store: any ClairDeviceIdentityStore
  private let transport: any ClairV2MobileTransport
  ...
  public init(
    ...
    transport: any ClairV2MobileTransport,
