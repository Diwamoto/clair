...
public enum ClairV2SessionJournalError: Error, Equatable, LocalizedError, Sendable {
  case invalidLimits
...
public struct ClairV2JournalSubscriberID: RawRepresentable, Codable, Hashable, Sendable,
  CustomStringConvertible
{
  ...
  public init(_ rawValue: String) throws {
    ...
    else { throw ClairV2SessionJournalError.invalidSubscriberID }
...
public struct ClairV2SessionJournalLimits: Codable, Equatable, Sendable {
  ...
  public init(
    ...
    else { throw ClairV2SessionJournalError.invalidLimits }
...
public struct ClairV2SessionRevisionSnapshot: Codable, Equatable, Sendable {
...
public enum ClairV2SessionJournalCatchUp: Equatable, Sendable {
  /// The subscriber's cursor already equals the journal head; nothing to
  /// replay.
  case upToDate(ClairV2SessionRevisionSnapshot)
  /// Events strictly after the subscriber's cursor, in revision order, that
  /// the journal can serve from its retained window.
  case replay(events: [ClairV2AgentNormalizedEvent], snapshot: ClairV2SessionRevisionSnapshot)
  ...
  case resyncRequired(ClairV2SessionRevisionSnapshot)
}

/// The outcome of ingesting one normalized event into the journal.
public struct ClairV2SessionJournalAppendResult: Equatable, Sendable {
...
///
/// This is deliberately independent of `ClairV2AgentCommandBoundary`'s
...
///
/// There is no on-disk persistence layer in the v2 daemon yet (H01-H07 keep
...
/// `ClairV2SessionJournalError.unknownSession` (no entry exists for that
...
public final class ClairV2SessionJournal: Sendable {
  private let limits: ClairV2SessionJournalLimits
  private let state: JournalState

  public init(limits: ClairV2SessionJournalLimits = .standard) {
    self.limits = limits
  ...
  ) throws -> ClairV2SessionRevisionSnapshot {
    try state.open(
  ...
  @discardableResult
  public func append(
    _ event: ClairV2AgentNormalizedEvent
  ) throws -> ClairV2SessionJournalAppendResult {
  ...
  public func subscribe(
    ...
    cursor: ReplayCursor
  ) throws -> ClairV2SessionJournalCatchUp {
  ...
  public func detach(_ subscriberID: ClairV2JournalSubscriberID, scope: ResourceScope) {
  ...
  /// stale data.
  public func close(identity: ClairV2AgentSessionIdentity, processGeneration: UInt64) {
  ...
  public func snapshot(scope: ResourceScope) throws -> ClairV2SessionRevisionSnapshot {
...
private final class JournalState: @unchecked Sendable {
  ...
  fileprivate struct SessionEntry {
    var identity: ClairV2AgentSessionIdentity
    var processGeneration: UInt64
    var lifecycle: ClairV2AgentLifecycleState
    var epoch: SessionEpoch
    var replay: ReplayState
    var buffer: [ClairV2AgentNormalizedEvent] = []
    var subscribers: [ClairV2JournalSubscriberID: SubscriberState] = [:]
    var faulted = false
  }
  ...
  init(limits: ClairV2SessionJournalLimits) {
    self.limits = limits
  }
    ...
    try lock.withLock {
      ...
      if let existing = sessions[id] {
        guard existing.identity == identity else {
          throw ClairV2SessionJournalError.staleGeneration(
        ...
        throw ClairV2SessionJournalError.sessionCapacity
      }
  ...
  func updateLifecycle(
    ...
    try lock.withLock {
      ...
      else { throw ClairV2SessionJournalError.unknownSession }
  ...
  func append(
    ...
    try lock.withLock {
      guard let id = event.scope.sessionID, var entry = sessions[id] else {
        throw ClairV2SessionJournalError.unknownSession
      }
      guard !entry.faulted else { throw ClairV2SessionJournalError.journalFaulted }
      ...
      do {
        ...
        sessions[id] = entry
        return ClairV2SessionJournalAppendResult(disposition: disposition, revision: revision)
      } catch {
  ...
  func subscribe(
    ...
    try lock.withLock {
      ...
      else { throw ClairV2SessionJournalError.subscriberCapacity }
      ...
      guard cursor.revision <= head else {
        ...
        throw ClairV2SessionJournalError.invalidCursor
      }
  ...
  func acknowledge(
    ...
    try lock.withLock {
      ...
      guard var subscriber = entry.subscribers[subscriberID] else {
        throw ClairV2SessionJournalError.unknownSubscriber
      }
      ...
      guard revision <= subscriber.lastDeliveredRevision else {
        ...
        throw ClairV2SessionJournalError.invalidAcknowledgement
      }
  ...
  func detach(_ subscriberID: ClairV2JournalSubscriberID, scope: ResourceScope) {
    lock.withLock {
  ...
  func close(identity: ClairV2AgentSessionIdentity, processGeneration: UInt64) {
    lock.withLock {
  ...
  func snapshot(scope: ResourceScope) throws -> ClairV2SessionRevisionSnapshot {
    try lock.withLock {
  ...
  private func attach(
    ...
    subscriberID: ClairV2JournalSubscriberID,
    delivered: Revision,
  ...
  private func makeSnapshot(_ entry: SessionEntry) -> ClairV2SessionRevisionSnapshot {
    ClairV2SessionRevisionSnapshot(
