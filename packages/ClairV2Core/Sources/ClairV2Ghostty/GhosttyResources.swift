...
/// by `scripts/v2-ghostty.sh vendor` from the same pinned build as the
...
public enum GhosttyResources {
  ...
  /// `packages/ClairV2Core/Vendor/ghostty/resources`, resolved relative to
  ...
  static var vendorResourcesDirectory: URL {
    URL(fileURLWithPath: #filePath)
      .deletingLastPathComponent() // ClairV2Ghostty
