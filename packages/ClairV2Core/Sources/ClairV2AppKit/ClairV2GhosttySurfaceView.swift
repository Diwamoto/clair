...
import Foundation
  ...
  /// libghostty is vendored (`scripts/v2-ghostty.sh vendor`), by a real
  ...
  /// `ClairV2LocalShellSession`, which stays only as the pre-vendor/
  /// pre-window fallback local shell (see `ClairV2GhosttyABI`'s header
