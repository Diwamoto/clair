...
/// The subset of `GhosttyVTTerminal` `ClairV2MobileTerminalSession`
/// (`ClairV2MobileKit`) actually drives. Exists so the session's attach/
...
/// unlike `ClairV2Ghostty`'s macOS embedder, which the T01/T08 precedent's
...
/// abstraction layer.
@MainActor
public protocol ClairV2TerminalEngine: AnyObject {
...
extension GhosttyVTTerminal: ClairV2TerminalEngine {}
