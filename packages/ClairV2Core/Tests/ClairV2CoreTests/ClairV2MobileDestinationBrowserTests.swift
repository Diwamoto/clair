...
private struct N04Fixture {
  ...
  func catalog(
    firstState: ClairV2WorkspaceRootState = .available,
    firstWorktreeState: ClairV2WorkspaceRootState = .available
  ) -> ClairV2WorkspaceCatalog {
    let firstWorktree = ClairV2WorktreeCatalogEntry(
      id: firstWorktreeID,
    ...
    let secondWorktree = ClairV2WorktreeCatalogEntry(
      id: secondWorktreeID,
    ...
    return ClairV2WorkspaceCatalog(projects: [
