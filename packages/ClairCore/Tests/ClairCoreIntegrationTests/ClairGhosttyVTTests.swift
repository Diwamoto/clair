...
/// run `scripts/ghostty.sh vendor-vt`. This file's "not vendored" tests
...
final class ClairGhosttyVTTests: XCTestCase {
  ...
  /// (never failed) everywhere else, matching `ClairGhosttyTests`'
