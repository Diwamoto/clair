...
public struct ClairTerminalModes: Sendable {
...
public enum ClairTerminalPaste {
  ...
  public static func needsConfirmation(_ text: String, modes: ClairTerminalModes) -> Bool {
  ...
  public static func encode(_ text: String, modes: ClairTerminalModes) -> Data {
    var out = ""
    var afterCR = false
...
public enum ClairTerminalFocus {
  public static func encode(focused: Bool, modes: ClairTerminalModes) -> Data {
    modes.focusReporting ? Data([0x1B, 0x5B, focused ? 0x49 : 0x4F]) : Data()
  }
}

public enum ClairTerminalMouseButton: Equatable, Sendable {
  case left, middle, right, wheelUp, wheelDown
}

public enum ClairTerminalMouseAction: Equatable, Sendable {
  case press, release, drag
}

public enum ClairTerminalMouse {
  ...
  public static func encode(
    _ button: ClairTerminalMouseButton, _ action: ClairTerminalMouseAction,
    column: Int, row: Int, modes: ClairTerminalModes
  ) -> Data {
...
public enum ClairTerminalCellWidth {
