...
public enum ClairTerminalKey: Equatable, Sendable {
  case text(String)
  case `return`
  case tab
  case backspace
  ...
  /// `ClairTerminalKeyEncoding.encode`).
...
/// `ClairTerminalProcess.enqueueTerminalInput` accepts). This is a
...
public enum ClairTerminalKeyEncoding {
  public static func encode(_ key: ClairTerminalKey) -> Data {
    switch key {
