...
public struct ClairMobileDestinationBrowserState: Equatable, Sendable {
  public private(set) var catalog: ClairWorkspaceCatalog
  ...
  public init(
    catalog: ClairWorkspaceCatalog = .init(projects: []),
  ...
  public var projects: [ClairProjectCatalogEntry] {
    catalog.projects.sorted { $0.id.rawValue < $1.id.rawValue }
  }

  public func worktrees(for projectID: ProjectID) -> [ClairWorktreeCatalogEntry] {
  ...
  private func project(_ projectID: ProjectID) -> ClairProjectCatalogEntry? {
