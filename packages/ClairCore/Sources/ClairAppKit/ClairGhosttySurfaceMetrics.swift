...
import Foundation
  ...
  public struct ClairGhosttyCellMetrics: Equatable, Sendable {
    ...
    public static func measuring(font: NSFont, contentScale: Double) -> ClairGhosttyCellMetrics {
