...
/// Machine-readable form of the Clair editor core invariants.
///
...
public enum EditorInvariants {
  public static let all: [EditorInvariant] = [
    ...
    EditorInvariant(
      ...
      rationale:
        "ADR-0014 and the rewrite plan forbid a CodeMirror/WKWebView fallback; the 10MB `setDocument` round trip cost 2997.26 ms.",
      provenBy: ["E06"]
    ),
  ]
